#!/usr/bin/env python3
"""
Set up and submit VASP jobs for phonopy displacement calculations (monolayer).

Thin wrapper around common/setup_displacements_impl.py -- identical logic to
phonopy/bilayer/setup_displacements.py, parameterized only by which
